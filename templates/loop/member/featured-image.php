 ...
 *
 * Template for the thumbnail of a looped member.
 *
 * Override this template by copying it to `your-theme/team/loop/member/featured-image.php`.
 *
 * @package Nice_Team
 * @since   1.0
 */
		...
		<figure class="nice-team-member-featured-image">
			<a class="thumbnail" href="<?php the_permalink(); ?>">
				<?php
					 ...
					 * settings (or the `image_size` attribute, if you use a
					 * shortcode) will be used for both the width and the
					 * height of the image.
					 *
