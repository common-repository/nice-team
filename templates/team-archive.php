 ...
 *
 * Template for team members page.
 *
 * Override this template by copying it to `your-theme/team/team-archive.php`.
 *
 * @package Nice_Team
 * @since   1.0
 */
	...
	<div class="hentry">
		...
		<div class="entry-content">
			<?php
				 ...
				 * through the`nice_team_archive_page` hook instead of the
				 * global context.
				 *
				 * Hooked here:
				 * @see nice_team_archive() - 10 (prints all published members)
				 *
				 * Hooked in:
