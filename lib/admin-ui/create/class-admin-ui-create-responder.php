...
/**
 * Class Nice_Team_Admin_UICreateResponder
 *
 * This class takes charge of the interaction of created Nice_Team_Admin_UI
 * instances with WordPress APIs.
 *
 * @since 1.0
 */
class Nice_Team_Admin_UICreateResponder extends Nice_Team_CreateResponder {
	/**
