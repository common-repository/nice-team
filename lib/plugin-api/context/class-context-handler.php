...
/**
 * Class Nice_Team_Context_Handler
 *
...
class Nice_Team_Context_Handler {
	...
	protected function get_current_context() {
		...
		if ( function_exists( 'nice_team_doing_shortcode' ) && nice_team_doing_shortcode() ) {
			$context = 'shortcode';
		}

		if ( is_null( $context ) && function_exists( 'nice_team_doing_widget' ) && nice_team_doing_widget() ) {
			$context = 'widget';
		}
