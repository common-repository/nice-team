...
/**
 * Class Nice_Team_IntegrationCreateResponder
 *
 * This class takes charge of the interaction of created
 * Nice_Team_Integration instances with WordPress APIs.
 *
 * @see   Nice_Team_Integration
 *
 * @since 1.0
 */
class Nice_Team_IntegrationCreateResponder extends Nice_Team_CreateResponder {
	/**
