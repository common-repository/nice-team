...
if ( ! class_exists( 'Nice_Team_Pointer_Collection' ) ) :
/**
 * Class Nice_Team_Pointer_Collection
 *
 ...
 */
class Nice_Team_Pointer_Collection extends Nice_Team_Entity {
	/**
	 * List of Nice_Team_Pointer instances.
	 *
	 * @since 1.0
	 * @var   array
	 */
