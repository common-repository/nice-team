...
/**
 * Class Nice_Team_Pointer_CollectionDisplayResponder
 *
 * This class takes charge of the Nice_Team_Pointer_Collection instances
 * to be displayed through WordPress APIs.
 *
 * @since   1.0
 */
class Nice_Team_Pointer_CollectionDisplayResponder extends Nice_Team_DisplayResponder {
	/**
	 ...
	 *
	 * @see    Nice_Team_Pointer_CollectionCreateResponder::get_formatted_pointers()
	 *
	 * @since  1.0
	 *
