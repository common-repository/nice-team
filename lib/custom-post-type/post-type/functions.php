...
if ( ! function_exists( 'nice_team_post_type_register' ) ) :
/**
 * Register a new custom post type.
 *
 * @uses  Nice_Team_Helper::register_custom_post_type()
 *
 * @since 1.1
 *
 * Accepted $args:
 ...
 */
function nice_team_post_type_register( $args = array(), $textdomain ) {
	$post_type = nice_team_post_type_create( array(
	 ...
	 */
	if ( is_admin() ) {
		nice_team_post_type_admin_create( array(
				'post_type'  => $post_type,
				'textdomain' => $textdomain,
			)
		);
 ...
 *
 * @return Nice_Team_Post_TypeService
 */
function nice_team_post_type_create( array $data = array() ) {
	return nice_team_create( 'Nice_Team_Post_Type', $data );
}
 ...
 * @return Nice_Team_Post_TypeService
 */
function nice_team_post_type_service() {
	return nice_team_service( 'Nice_Team_Post_Type' );
}
