...
/**
 * Class Nice_Team_MetaboxUpdateResponder
 *
 * This class takes charge of the interaction of updated Nice_Team_Metabox
 * instances with WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Team_MetaboxUpdateResponder extends Nice_Team_UpdateResponder {
	/**
