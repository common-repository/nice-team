...
/**
 * Class Nice_Team_GlancerDisplayResponder
 *
 * This class takes charge of the Nice_Team_Glancer instances to be
 * displayed through WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Team_GlancerDisplayResponder extends Nice_Team_DisplayResponder {
	/**
	 * Fire main responder functionality.
	 *
	 * @since 1.1
	 *
	 * @param Nice_Team_EntityInterface $glancer Initialised glancer instance.
	 */
	public function __invoke( Nice_Team_EntityInterface $glancer ) {
		global $wp_version;
	 ...
	 *
	 * @uses  Nice_Team_GlancerDisplayResponder::get_single_item()
	 *
	 * @since 1.1
	 */
	 ...
	 *
	 * @uses   Nice_Team_GlancerDisplayResponder::get_markup()
	 *
	 * @since  1.1
	 *
