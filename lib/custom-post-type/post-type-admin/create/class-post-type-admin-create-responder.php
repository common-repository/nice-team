...
/**
 * Class Nice_Team_Post_Type_AdminCreateResponder
 *
 * This class takes charge of the interaction of created Nice_Team_Post_Type_Admin
 * instances with WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Team_Post_Type_AdminCreateResponder extends Nice_Team_CreateResponder {
	/**
	 * Fire main responder functionality.
	 *
	 * @since 1.1
	 *
	 * @param Nice_Team_EntityInterface $post_type_admin
	 */
	public function __invoke( Nice_Team_EntityInterface $post_type_admin ) {
