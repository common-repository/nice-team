...
/**
 * Class Nice_Team_CreateActionAbstract
 *
 ...
 * @since   1.0
 */
abstract class Nice_Team_CreateActionAbstract extends Nice_Team_ActionAbstract {
	/**
	...
	public function __invoke( array $data ) {
		...
		if ( $instance instanceof Nice_Team_EntityInterface ) {
