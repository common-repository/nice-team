...
/**
 * Class Nice_Team_CreateResponder
 *
 ...
 * @since 1.0
 */
class Nice_Team_CreateResponder extends Nice_Team_ResponderAbstract {
	/**
	...
	protected function load_libraries() {
		nice_team_autoload_libraries( apply_filters( $this->domain . '_libraries', array(), $this->data ) );
	}
