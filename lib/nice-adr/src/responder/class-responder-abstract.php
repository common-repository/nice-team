...
/**
 * Class Nice_Team_ResponderAbstract
 *
 ...
 * @since 1.0
 */
abstract class Nice_Team_ResponderAbstract implements Nice_Team_ResponderInterface {
	/**
	 * Current Nice_Team_Entity instance.
	 *
	 ...
	 * @since 1.0
	 *
	 * @param Nice_Team_EntityInterface $data Current Nice_Team_EntityInterface instance.
	 */
	protected function set_data( Nice_Team_EntityInterface $data ) {
		/**
	 ...
	 * @param Nice_Team_EntityInterface $instance
	 */
	protected function set_domain( Nice_Team_EntityInterface $instance ) {
		/**
		 * Set current state of data.
		 */
